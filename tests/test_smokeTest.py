...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    self.driver.get("https://202296.github.io/cse270-teton/")
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Mouhamed jean patric")
    self.driver.find_element(By.NAME, "lname").send_keys("Koko")
    self.driver.find_element(By.NAME, "bizname").send_keys("Teton building")
